...
namespace Microsoft { namespace Azure { namespace SpatialAnchors
{
    ...
    using UpdatedSensorFingerprintRequiredDelegate = std::function<void(void*, const std::shared_ptr<SensorFingerprintEventArgs> &)>;
    ...
    struct AnchorLocateCriteria : std::enable_shared_from_this<AnchorLocateCriteria>
    {
        ...
        std::shared_ptr<NearAnchorCriteria> NearAnchor() const;
        void NearAnchor(std::shared_ptr<NearAnchorCriteria> const& value);
        std::shared_ptr<NearDeviceCriteria> NearDevice() const;
        void NearDevice(std::shared_ptr<NearDeviceCriteria> const& value);
        AnchorDataCategory RequestedCategories() const;
        void RequestedCategories(AnchorDataCategory const& value);
        LocateStrategy Strategy() const;
    ...
    struct AnchorLocatedEventArgs : std::enable_shared_from_this<AnchorLocatedEventArgs>
    {
        ...
        std::shared_ptr<CloudSpatialAnchor> Anchor() const;
        std::string Identifier() const;
        LocateAnchorStatus Status() const;
        LocateStrategy Strategy() const;
        std::shared_ptr<CloudSpatialAnchorWatcher> Watcher() const;
    ...
    struct CloudSpatialAnchor : std::enable_shared_from_this<CloudSpatialAnchor>
    {
        ...
        winrt::Windows::Perception::Spatial::SpatialAnchor LocalAnchor() const;
    ...
    struct CloudSpatialAnchorSessionDiagnostics : std::enable_shared_from_this<CloudSpatialAnchorSessionDiagnostics>
    {
        ...
        SessionLogLevel LogLevel() const;
    ...
    struct CloudSpatialAnchorSession : std::enable_shared_from_this<CloudSpatialAnchorSession>
    {
        ...
        std::shared_ptr<SessionConfiguration> Configuration() const;
        std::shared_ptr<CloudSpatialAnchorSessionDiagnostics> Diagnostics() const;
        SessionLogLevel LogLevel() const;
        void LogLevel(SessionLogLevel const& value);
        std::shared_ptr<PlatformLocationProvider> LocationProvider() const;
        void LocationProvider(std::shared_ptr<PlatformLocationProvider> const& value);
        ...
        void GetNearbyAnchorIdsAsync(std::shared_ptr<NearDeviceCriteria> const & criteria, std::function<void(Status, std::shared_ptr<IVector<std::string>>)> callback);
    ...
    struct GeoLocation : std::enable_shared_from_this<GeoLocation>
    {
        GeoLocation();
    ...
    struct NearAnchorCriteria : std::enable_shared_from_this<NearAnchorCriteria>
    {
        ...
        std::shared_ptr<CloudSpatialAnchor> SourceAnchor() const;
    ...
    struct NearDeviceCriteria : std::enable_shared_from_this<NearDeviceCriteria>
    {
        NearDeviceCriteria();
    ...
    struct PlatformLocationProvider : std::enable_shared_from_this<PlatformLocationProvider>
    {
        PlatformLocationProvider();
        PlatformLocationProvider(void* handle, bool noCopy = true);
        ~PlatformLocationProvider();

        std::shared_ptr<SensorCapabilities> Sensors() const;
        GeoLocationStatusResult GeoLocationStatus() const;
        WifiStatusResult WifiStatus() const;
        BluetoothStatusResult BluetoothStatus() const;
        std::shared_ptr<GeoLocation> GetLocationEstimate();
        void Start();
        void Stop();
    ...
    struct SensorCapabilities : std::enable_shared_from_this<SensorCapabilities>
    {
    ...
    struct SensorFingerprintEventArgs : std::enable_shared_from_this<SensorFingerprintEventArgs>
    {
        SensorFingerprintEventArgs(void* handle, bool noCopy = true);
        ~SensorFingerprintEventArgs();

        std::shared_ptr<GeoLocation> GeoPosition() const;
        void GeoPosition(std::shared_ptr<GeoLocation> const& value);
    ...
    struct SessionErrorEventArgs : std::enable_shared_from_this<SessionErrorEventArgs>
    {
        ...
        CloudSpatialErrorCode ErrorCode() const;
    ...
    struct SessionStatus : std::enable_shared_from_this<SessionStatus>
    {
        ...
        SessionUserFeedback UserFeedback() const;
    ...
    struct SessionUpdatedEventArgs : std::enable_shared_from_this<SessionUpdatedEventArgs>
    {
        ...
        std::shared_ptr<SessionStatus> Status() const;
